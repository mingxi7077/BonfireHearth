...
public class PurpurWorldConfig {
    ...
    public boolean bonfireEntityTrackingBudgetEnabled = true;
    public double bonfireEntityTrackingBudgetHighPressureMspt = 40.0D;
    public double bonfireEntityTrackingBudgetExtremePressureMspt = 47.0D;
    public int bonfireEntityTrackingBudgetHighPressureInterval = 2;
    public int bonfireEntityTrackingBudgetExtremePressureInterval = 4;
    public int bonfireEntityTrackingBudgetCrowdTrackedPlayers = 12;
    public boolean bonfireEntityTrackingBudgetThrottleDisplays = true;
    public boolean bonfireEntityTrackingBudgetThrottleInteractions = true;
    public boolean bonfireEntityTrackingBudgetThrottleMarkerArmorStands = true;
    public boolean bonfireEntityTrackingBudgetThrottleInvisibleNoGravityArmorStands = true;
    private void bonfireEntityTrackingBudgetSettings() {
        bonfireEntityTrackingBudgetEnabled = getBoolean("settings.bonfire.entity-tracking-budget.enabled", bonfireEntityTrackingBudgetEnabled);
        bonfireEntityTrackingBudgetHighPressureMspt = getDouble("settings.bonfire.entity-tracking-budget.thresholds.high-pressure-mspt", bonfireEntityTrackingBudgetHighPressureMspt);
        bonfireEntityTrackingBudgetExtremePressureMspt = getDouble("settings.bonfire.entity-tracking-budget.thresholds.extreme-pressure-mspt", bonfireEntityTrackingBudgetExtremePressureMspt);
        bonfireEntityTrackingBudgetHighPressureInterval = getInt("settings.bonfire.entity-tracking-budget.intervals.high-pressure", bonfireEntityTrackingBudgetHighPressureInterval);
        bonfireEntityTrackingBudgetExtremePressureInterval = getInt("settings.bonfire.entity-tracking-budget.intervals.extreme-pressure", bonfireEntityTrackingBudgetExtremePressureInterval);
        bonfireEntityTrackingBudgetCrowdTrackedPlayers = getInt("settings.bonfire.entity-tracking-budget.thresholds.crowd-tracked-players", bonfireEntityTrackingBudgetCrowdTrackedPlayers);
        bonfireEntityTrackingBudgetThrottleDisplays = getBoolean("settings.bonfire.entity-tracking-budget.entities.display", bonfireEntityTrackingBudgetThrottleDisplays);
        bonfireEntityTrackingBudgetThrottleInteractions = getBoolean("settings.bonfire.entity-tracking-budget.entities.interaction", bonfireEntityTrackingBudgetThrottleInteractions);
        bonfireEntityTrackingBudgetThrottleMarkerArmorStands = getBoolean("settings.bonfire.entity-tracking-budget.entities.marker-armor-stand", bonfireEntityTrackingBudgetThrottleMarkerArmorStands);
        bonfireEntityTrackingBudgetThrottleInvisibleNoGravityArmorStands = getBoolean("settings.bonfire.entity-tracking-budget.entities.invisible-no-gravity-armor-stand", bonfireEntityTrackingBudgetThrottleInvisibleNoGravityArmorStands);
    }

    public boolean bonfireMobAiBudgetEnabled = true;
    public int bonfireMobAiBudgetHighPressureGoalSelectorInterval = 3;
    public int bonfireMobAiBudgetExtremePressureGoalSelectorInterval = 5;
    private void bonfireMobAiBudgetSettings() {
        bonfireMobAiBudgetEnabled = getBoolean("settings.bonfire.mob-ai-budget.enabled", bonfireMobAiBudgetEnabled);
        bonfireMobAiBudgetHighPressureGoalSelectorInterval = getInt("settings.bonfire.mob-ai-budget.goal-selector-intervals.high-pressure", bonfireMobAiBudgetHighPressureGoalSelectorInterval);
        bonfireMobAiBudgetExtremePressureGoalSelectorInterval = getInt("settings.bonfire.mob-ai-budget.goal-selector-intervals.extreme-pressure", bonfireMobAiBudgetExtremePressureGoalSelectorInterval);
    }

    public boolean bonfireChunkSendBudgetEnabled = true;
    public double bonfireChunkSendBudgetHighPressureMspt = 40.0D;
    public double bonfireChunkSendBudgetExtremePressureMspt = 47.0D;
    public double bonfireChunkSendBudgetHighPressureMaxChunksPerTick = 6.0D;
    public double bonfireChunkSendBudgetExtremePressureMaxChunksPerTick = 3.0D;
    public int bonfireChunkSendBudgetHighPressureMaxUnacknowledgedBatches = 6;
    public int bonfireChunkSendBudgetExtremePressureMaxUnacknowledgedBatches = 3;
    private void bonfireChunkSendBudgetSettings() {
        bonfireChunkSendBudgetEnabled = getBoolean("settings.bonfire.chunk-send-budget.enabled", bonfireChunkSendBudgetEnabled);
        bonfireChunkSendBudgetHighPressureMspt = getDouble("settings.bonfire.chunk-send-budget.thresholds.high-pressure-mspt", bonfireChunkSendBudgetHighPressureMspt);
        bonfireChunkSendBudgetExtremePressureMspt = getDouble("settings.bonfire.chunk-send-budget.thresholds.extreme-pressure-mspt", bonfireChunkSendBudgetExtremePressureMspt);
        bonfireChunkSendBudgetHighPressureMaxChunksPerTick = getDouble("settings.bonfire.chunk-send-budget.limits.high-pressure-max-chunks-per-tick", bonfireChunkSendBudgetHighPressureMaxChunksPerTick);
        bonfireChunkSendBudgetExtremePressureMaxChunksPerTick = getDouble("settings.bonfire.chunk-send-budget.limits.extreme-pressure-max-chunks-per-tick", bonfireChunkSendBudgetExtremePressureMaxChunksPerTick);
        bonfireChunkSendBudgetHighPressureMaxUnacknowledgedBatches = getInt("settings.bonfire.chunk-send-budget.limits.high-pressure-max-unacknowledged-batches", bonfireChunkSendBudgetHighPressureMaxUnacknowledgedBatches);
        bonfireChunkSendBudgetExtremePressureMaxUnacknowledgedBatches = getInt("settings.bonfire.chunk-send-budget.limits.extreme-pressure-max-unacknowledged-batches", bonfireChunkSendBudgetExtremePressureMaxUnacknowledgedBatches);
    }

    public boolean bonfireChunkLoadBudgetEnabled = true;
    public double bonfireChunkLoadBudgetHighPressureMspt = 40.0D;
    public double bonfireChunkLoadBudgetExtremePressureMspt = 47.0D;
    public double bonfireChunkLoadBudgetHighPressureLoadRateMultiplier = 0.75D;
    public double bonfireChunkLoadBudgetExtremePressureLoadRateMultiplier = 0.35D;
    public double bonfireChunkLoadBudgetHighPressureGenRateMultiplier = 0.50D;
    public double bonfireChunkLoadBudgetExtremePressureGenRateMultiplier = 0.20D;
    public int bonfireChunkLoadBudgetHighPressureMaxConcurrentLoads = 24;
    public int bonfireChunkLoadBudgetExtremePressureMaxConcurrentLoads = 12;
    public int bonfireChunkLoadBudgetHighPressureMaxConcurrentGenerates = 8;
    public int bonfireChunkLoadBudgetExtremePressureMaxConcurrentGenerates = 4;
    private void bonfireChunkLoadBudgetSettings() {
        bonfireChunkLoadBudgetEnabled = getBoolean("settings.bonfire.chunk-load-budget.enabled", bonfireChunkLoadBudgetEnabled);
        bonfireChunkLoadBudgetHighPressureMspt = getDouble("settings.bonfire.chunk-load-budget.thresholds.high-pressure-mspt", bonfireChunkLoadBudgetHighPressureMspt);
        bonfireChunkLoadBudgetExtremePressureMspt = getDouble("settings.bonfire.chunk-load-budget.thresholds.extreme-pressure-mspt", bonfireChunkLoadBudgetExtremePressureMspt);
        bonfireChunkLoadBudgetHighPressureLoadRateMultiplier = getDouble("settings.bonfire.chunk-load-budget.rates.high-pressure-load-rate-multiplier", bonfireChunkLoadBudgetHighPressureLoadRateMultiplier);
        bonfireChunkLoadBudgetExtremePressureLoadRateMultiplier = getDouble("settings.bonfire.chunk-load-budget.rates.extreme-pressure-load-rate-multiplier", bonfireChunkLoadBudgetExtremePressureLoadRateMultiplier);
        bonfireChunkLoadBudgetHighPressureGenRateMultiplier = getDouble("settings.bonfire.chunk-load-budget.rates.high-pressure-gen-rate-multiplier", bonfireChunkLoadBudgetHighPressureGenRateMultiplier);
        bonfireChunkLoadBudgetExtremePressureGenRateMultiplier = getDouble("settings.bonfire.chunk-load-budget.rates.extreme-pressure-gen-rate-multiplier", bonfireChunkLoadBudgetExtremePressureGenRateMultiplier);
        bonfireChunkLoadBudgetHighPressureMaxConcurrentLoads = getInt("settings.bonfire.chunk-load-budget.limits.high-pressure-max-concurrent-loads", bonfireChunkLoadBudgetHighPressureMaxConcurrentLoads);
        bonfireChunkLoadBudgetExtremePressureMaxConcurrentLoads = getInt("settings.bonfire.chunk-load-budget.limits.extreme-pressure-max-concurrent-loads", bonfireChunkLoadBudgetExtremePressureMaxConcurrentLoads);
        bonfireChunkLoadBudgetHighPressureMaxConcurrentGenerates = getInt("settings.bonfire.chunk-load-budget.limits.high-pressure-max-concurrent-generates", bonfireChunkLoadBudgetHighPressureMaxConcurrentGenerates);
        bonfireChunkLoadBudgetExtremePressureMaxConcurrentGenerates = getInt("settings.bonfire.chunk-load-budget.limits.extreme-pressure-max-concurrent-generates", bonfireChunkLoadBudgetExtremePressureMaxConcurrentGenerates);
    }

    public boolean bonfireEntitySyncBudgetEnabled = true;
    public boolean bonfireEntitySyncBudgetThrottleStaticLivingEntities = true;
    public int bonfireEntitySyncBudgetHighPressureInterval = 2;
    public int bonfireEntitySyncBudgetExtremePressureInterval = 4;
    public int bonfireEntitySyncBudgetRequiredStationaryTicks = 20;
    public double bonfireEntitySyncBudgetMaxStationaryVelocitySqr = 0.0004D;
    public int bonfireEntitySyncBudgetPacketGateMinTrackedPlayers = 6;
    public int bonfireEntitySyncBudgetMetadataHighPressureInterval = 2;
    public int bonfireEntitySyncBudgetMetadataExtremePressureInterval = 4;
    public int bonfireEntitySyncBudgetEquipmentHighPressureInterval = 3;
    public int bonfireEntitySyncBudgetEquipmentExtremePressureInterval = 6;
    public int bonfireEntitySyncBudgetHeadRotationHighPressureInterval = 3;
    public int bonfireEntitySyncBudgetHeadRotationExtremePressureInterval = 6;
    public int bonfireEntitySyncBudgetAttributesHighPressureInterval = 4;
    public int bonfireEntitySyncBudgetAttributesExtremePressureInterval = 8;
    public double bonfireEntitySyncBudgetFarViewerDistance = 24.0D;
    public int bonfireEntitySyncBudgetFarViewerIntervalBoost = 1;
    private void bonfireEntitySyncBudgetSettings() {
        bonfireEntitySyncBudgetEnabled = getBoolean("settings.bonfire.entity-sync-budget.enabled", bonfireEntitySyncBudgetEnabled);
        bonfireEntitySyncBudgetThrottleStaticLivingEntities = getBoolean("settings.bonfire.entity-sync-budget.entities.static-living", bonfireEntitySyncBudgetThrottleStaticLivingEntities);
        bonfireEntitySyncBudgetHighPressureInterval = getInt("settings.bonfire.entity-sync-budget.intervals.high-pressure", bonfireEntitySyncBudgetHighPressureInterval);
        bonfireEntitySyncBudgetExtremePressureInterval = getInt("settings.bonfire.entity-sync-budget.intervals.extreme-pressure", bonfireEntitySyncBudgetExtremePressureInterval);
        bonfireEntitySyncBudgetRequiredStationaryTicks = getInt("settings.bonfire.entity-sync-budget.conditions.required-stationary-ticks", bonfireEntitySyncBudgetRequiredStationaryTicks);
        bonfireEntitySyncBudgetMaxStationaryVelocitySqr = getDouble("settings.bonfire.entity-sync-budget.conditions.max-stationary-velocity-sqr", bonfireEntitySyncBudgetMaxStationaryVelocitySqr);
        bonfireEntitySyncBudgetPacketGateMinTrackedPlayers = getInt("settings.bonfire.entity-sync-budget.conditions.packet-gate-min-tracked-players", bonfireEntitySyncBudgetPacketGateMinTrackedPlayers);
        bonfireEntitySyncBudgetMetadataHighPressureInterval = getInt("settings.bonfire.entity-sync-budget.packet-intervals.metadata.high-pressure", bonfireEntitySyncBudgetMetadataHighPressureInterval);
        bonfireEntitySyncBudgetMetadataExtremePressureInterval = getInt("settings.bonfire.entity-sync-budget.packet-intervals.metadata.extreme-pressure", bonfireEntitySyncBudgetMetadataExtremePressureInterval);
        bonfireEntitySyncBudgetEquipmentHighPressureInterval = getInt("settings.bonfire.entity-sync-budget.packet-intervals.equipment.high-pressure", bonfireEntitySyncBudgetEquipmentHighPressureInterval);
        bonfireEntitySyncBudgetEquipmentExtremePressureInterval = getInt("settings.bonfire.entity-sync-budget.packet-intervals.equipment.extreme-pressure", bonfireEntitySyncBudgetEquipmentExtremePressureInterval);
        bonfireEntitySyncBudgetHeadRotationHighPressureInterval = getInt("settings.bonfire.entity-sync-budget.packet-intervals.head-rotation.high-pressure", bonfireEntitySyncBudgetHeadRotationHighPressureInterval);
        bonfireEntitySyncBudgetHeadRotationExtremePressureInterval = getInt("settings.bonfire.entity-sync-budget.packet-intervals.head-rotation.extreme-pressure", bonfireEntitySyncBudgetHeadRotationExtremePressureInterval);
        bonfireEntitySyncBudgetAttributesHighPressureInterval = getInt("settings.bonfire.entity-sync-budget.packet-intervals.attributes.high-pressure", bonfireEntitySyncBudgetAttributesHighPressureInterval);
        bonfireEntitySyncBudgetAttributesExtremePressureInterval = getInt("settings.bonfire.entity-sync-budget.packet-intervals.attributes.extreme-pressure", bonfireEntitySyncBudgetAttributesExtremePressureInterval);
        bonfireEntitySyncBudgetFarViewerDistance = getDouble("settings.bonfire.entity-sync-budget.conditions.far-viewer-distance", bonfireEntitySyncBudgetFarViewerDistance);
        bonfireEntitySyncBudgetFarViewerIntervalBoost = getInt("settings.bonfire.entity-sync-budget.conditions.far-viewer-interval-boost", bonfireEntitySyncBudgetFarViewerIntervalBoost);
    }
